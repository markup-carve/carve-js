 ...
 *
 * Known limitations:
 *  - Markdown indented (4-space) code blocks are passed through byte-for-byte.
 *    Carve has no indented code block (like Djot), so use a fenced ``` block
 *    in the source for a faithful rendered migration.
